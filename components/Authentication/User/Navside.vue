  ...
  <div>
    ...
    <div class="dashboard_sidetop">
      ...
      <div class="sidetop_middle">
        <ul>
          <nuxt-link to="/panel" tag="li" exact>
          ...
          <!-- <nuxt-link to="/panel/project" tag="li">
            <div class="li-container">
              <div class="li-icon">
                <svg
                  width="28"
          ...
          <nuxt-link to="/panel/employee" tag="li">
            <div class="li-container">
              <div class="li-icon">
                <svg
                  width="28"
          ...
          <nuxt-link to="/panel/task" tag="li">
            <div class="li-container">
              <div class="li-icon">
                <svg
                  width="28"
          ...
          <nuxt-link to="/panel/todo" tag="li">
            <div class="li-container">
              <div class="li-icon">
                <svg
                  width="28"
          ...
          <nuxt-link to="/panel/settings" tag="li">
            <div class="li-container">
              <div class="li-icon">
                <!-- <svg
                  width="30"
